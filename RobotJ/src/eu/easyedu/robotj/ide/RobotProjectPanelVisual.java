...
public class RobotProjectPanelVisual extends JPanel implements DocumentListener {
    
    public static final String PROP_PROJECT_NAME = "projectName";
    
    private RobotProjectWizardPanel panel;
    
    /** Creates new form PanelProjectLocationVisual */
    public RobotProjectPanelVisual(RobotProjectWizardPanel panel) {
        initComponents();
        this.panel = panel;
